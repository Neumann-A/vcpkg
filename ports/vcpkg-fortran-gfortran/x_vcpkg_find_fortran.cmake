...
function(x_vcpkg_find_fortran)
    ...
    if(NOT VCPKG_DETECT_CMAKE_Fortran_COMPILER)
        ...
        if(WIN32)
            ...
            message(FATAL_ERROR "Unable to detect a Fortran compiler. Please install one (e.g. gfortran) and make it available for CMake (e.g. by putting it on the PATH)!")
        endif()
    endif()
