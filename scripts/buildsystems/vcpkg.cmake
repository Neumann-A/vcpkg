...
set(VCPKG_OVERRIDE_FIND_PACKAGE_NAME "${Z_VCPKG_FIND_PACKAGE_US}${VCPKG_OVERRIDE_FIND_PACKAGE_NAME}" CACHE INTERNAL "")
...
macro(z_vcpkg_underlying_find_package z_vcpkg_underlying_find_package_name)
    ...
    if(Z_VCPKG_CHAIN_COMMANDS)
        cmake_language(CALL _${VCPKG_OVERRIDE_FIND_PACKAGE_NAME} "${z_vcpkg_underlying_find_package_name}" ${z_vcpkg_underlying_find_package_name_ARGN})
    else()
...
macro("${VCPKG_OVERRIDE_FIND_PACKAGE_NAME}" z_vcpkg_find_package_package_name)
    ...
    elseif("${z_vcpkg_find_package_lowercase_package_name}" STREQUAL "grpc" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/grpc")
        ...
        z_vcpkg_underlying_find_package("${z_vcpkg_find_package_package_name}" ${ARGN})
    endif()
